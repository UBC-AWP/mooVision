...
from config import UNLABELLED_CLIPS_DIR
...
CROSS_SUCKING_PROMPT = (
    ...
    "Analyse the video frame by frame. For every frame where cross-sucking "
    "clearly occurs, return one tight 2D bounding box that encloses both "
...
video_path = UNLABELLED_CLIPS_DIR / "Pen 2 - Group 2/POSTWEANING/Day 2/CS_0055_POSTWEAN_d2_p2_cowT_03112025_ch02-20251103151315_28766_28782.mp4"
