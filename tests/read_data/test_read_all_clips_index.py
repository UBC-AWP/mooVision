...
from scripts.read_data.read_all_clips_index import (
    read_data,
    validate_data,
    save_data,
...
from scripts.read_data.schema import schema, processed_schema
...
def make_valid_df(n=2, with_labels=False):
    ...
    if with_labels:
        df["labelled_clip_relative_path"] = [
            f"Pen 2/POSTWEAN/Day 1/000{i}.zip" for i in range(n)
        ]
    return df
